...
<?php
   ...
   ?>
            <tr>
              <td><?=$row['idnewpaper']?></td>
              <td><?=$row['tieu_de']?></td>
              <td><?=$row['doc']?></td>        
              <td>
          <a href="sua.php?id=<?php echo $row['idnewpaper']; ?>" type="button "class="button1">Sửa</a>
          <a href="xoa.php?id=<?php echo $row['idnewpaper']; ?>" onclick="return confirm('Hành động sẽ xóa đi bài báo. Xóa ?');" type="button" class="button1">Xóa</a>
          <?php }?>
        </td>
            </tr>
   </table>
