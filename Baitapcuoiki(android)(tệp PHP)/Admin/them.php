...
<header class="header">
   ...
   <section class="flex">
      ...
      <?php if(isset($_POST['submit']))
      {
         $name=$_POST['name'];
         $doc=$_POST['motasp'];
         $sql="INSERT INTO newspaper (tieu_de, image, doc) VALUES ('$name','$photo','$doc')";
         $result = mysqli_query($connect, $sql);

         if($result)
            {
               echo '<script language="javascript">alert("Thêm báo mới thành công!!!"); window.location="sanpham.php";</script>';
         ...
         <form action="" method="post" enctype="multipart/form-data">
            <h3>Thêm bài báo</h3>
            <input type="text" required maxlength="50" name="name" placeholder="Nhập tên của bài báo" class="box">
