...
class Feedback : AppCompatActivity() {
    ...
    private val urlGetData: String = "http://192.168.1.8/Baitapcuoiki(android)/getdatacmt.php"
    private val urlAddComment: String = "http://192.168.1.8/Baitapcuoiki(android)/addcomment.php"
    private val urlDeleteComment: String =
        "http://192.168.1.8/Baitapcuoiki(android)/deletecomment.php"
    private val urlEditComment: String = "http://192.168.1.8/Baitapcuoiki(android)/editcomment.php"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lvComment = findViewById(R.id.rvDonggop)
        editTextNoidung = findViewById(R.id.editTextTextNoidung)
        buttonAdd = findViewById(R.id.buttonadd)
        buttonDelete = findViewById(R.id.buttondlt)
